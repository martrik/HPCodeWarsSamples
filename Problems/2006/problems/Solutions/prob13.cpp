...
void ReadPieces( Square PieceList[9] )
{
    ...
    {
        for( int j=0; j<4; j++ )
            printf( "%c%c ", PieceList[i].frog[j].color, PieceList[i].frog[j].part );
        printf( "\n" );
    }
}
...
int main(int /*argc*/, char* /*argv*/[])
{
    ...
    {
        for( int col=0; col<3; col++ )
            printf( "%d:%3d   ", 1+Board[row][col].piece, Board[row][col].rotation );
        printf( "\n" );
    }
    ...
    for( int row=0; row<3; row++ )
    {
        for( int tmb=0; tmb<3; tmb++ )
        {
            for( int col=0; col<3; col++ )
            {
                ...
                {
                   case 0:
                       printf( "   %c%c    ", PieceList[p].frog[top].color,
                                              PieceList[p].frog[top].part );
                       break;
                   case 1:
                       printf( "%c%c- %d-%c%c ", PieceList[p].frog[left].color,
                       ...
                       break;
                   case 2:
                       printf( "   %c%c    ", PieceList[p].frog[bottom].color,
